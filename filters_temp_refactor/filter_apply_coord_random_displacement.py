...
class MESHLAB_PG_apply_coord_random_displacement(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        msg_end = (
            "Batch Random Vertex Displacement concluído"
            if len(original_objs) > 1
            else "Random Vertex Displacement concluído"
        )
