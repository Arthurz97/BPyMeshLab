...
class MESHLAB_PG_meshing_remove_all_faces(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        if is_batch or len(original_objs) == 1:
            ...
            msg_end = (
                "Batch Delete ALL Faces concluído"
                if len(original_objs) > 1
                else "Delete ALL Faces concluído"
            )
        ...
        # MODO GLOBAL (BOOLEAN MANIFOLD VIA COLLECTION)
            ...
            return status, "Global Delete ALL Faces concluído com sucesso."
