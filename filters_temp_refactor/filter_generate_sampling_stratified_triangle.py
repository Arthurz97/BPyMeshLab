...
class MESHLAB_PG_generate_sampling_stratified_triangle(
    ...
    def apply_filter(cls, context, props):
        ...
        if is_batch or len(original_objs) == 1:
            ...
            msg_end = (
                "Batch Stratified Triangle Sampling concluído"
                if len(original_objs) > 1
                else "Stratified Triangle Sampling concluído"
            )
        ...
        # MODO GLOBAL (BOOLEAN MANIFOLD VIA COLLECTION)
            ...
            return status, "Global Stratified Triangle Sampling gerado com sucesso."
