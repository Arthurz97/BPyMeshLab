...
class MESHLAB_PG_generate_sampling_regular_recursive(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        if is_batch or len(original_objs) == 1:
            ...
            msg_end = (
                "Batch Regular Recursive Sampling concluído"
                if len(original_objs) > 1
                else "Regular Recursive Sampling concluído"
            )
        ...
        # MODO GLOBAL (BOOLEAN MANIFOLD VIA COLLECTION)
            ...
            return status, "Global Regular Recursive Sampling gerado com sucesso."
