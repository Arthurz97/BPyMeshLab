...
class MESHLAB_PG_meshing_repair_non_manifold_edges(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        msg_end = (
            "Batch Repair non Manifold Edges concluído"
            if len(original_objs) > 1
            else "Repair non Manifold Edges concluído"
        )
