...
class MESHLAB_PG_meshing_remove_duplicate_faces(PropertyGroup, MeshLabFilterBase):
    pymeshlab_filter = "meshing_remove_duplicate_faces"
    ...
    def apply_filter(cls, context, props):
        ...
        msg_end = (
            "Batch Remove Duplicate Faces concluído"
            if len(original_objs) > 1
            else "Remove Duplicate Faces concluído"
        )
