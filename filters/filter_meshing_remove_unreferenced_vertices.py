...
class MESHLAB_PG_meshing_remove_unreferenced_vertices(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        # Processamento iterativo (Batch) forçado para isolar a limpeza de cada malha
        ...
        msg_end = (
            "Batch Remove Unreferenced Vertices concluído"
            if len(original_objs) > 1
            else "Remove Unreferenced Vertices concluído"
        )
