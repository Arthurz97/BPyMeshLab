...
class MESHLAB_PG_meshing_surface_subdivision_ls3_loop(PropertyGroup, MeshLabFilterBase):
    pymeshlab_filter = "meshing_surface_subdivision_ls3_loop"
    ...
    def apply_filter(cls, context, props):
        ...
        if is_batch or len(original_objs) == 1:
            ...
            msg_end = (
                "Batch LS3 Loop concluído"
                if len(original_objs) > 1
                else "LS3 Loop Subdivision concluído"
            )
        ...
        # MODO GLOBAL (BOOLEAN MANIFOLD VIA COLLECTION)
            ...
            return status, "Global LS3 Loop Subdivision gerado com sucesso."
