...
class MESHLAB_PG_meshing_surface_subdivision_doo_sabin(
    ...
    def apply_filter(cls, context, props):
        ...
        # Processamento iterativo (Batch) é a única rota segura, evitando colapso topológico por booleanas
        for obj in original_objs:
        ...
        msg_end = (
            "Batch Doo Sabin concluído"
            if len(original_objs) > 1
            else "Doo Sabin Subdivision concluído"
        )
