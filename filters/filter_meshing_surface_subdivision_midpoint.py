...
class MESHLAB_PG_meshing_surface_subdivision_midpoint(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        if is_batch or len(original_objs) == 1:
            ...
            msg_end = (
                "Batch Midpoint concluído"
                if len(original_objs) > 1
                else "Midpoint Subdivision concluído"
            )
        ...
        # MODO GLOBAL (BOOLEAN MANIFOLD VIA COLLECTION)
            ...
            return status, "Global Midpoint Subdivision gerado com sucesso."
