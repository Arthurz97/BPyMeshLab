...
class MESHLAB_PG_apply_coord_hc_laplacian_smoothing(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        msg_end = (
            "Batch HC Laplacian Smooth concluído"
            if len(original_objs) > 1
            else "HC Laplacian Smooth concluído"
        )
