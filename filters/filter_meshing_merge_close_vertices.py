...
class MESHLAB_PG_meshing_merge_close_vertices(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        # Processamento iterativo (Batch) é a única rota imposta
        ...
        msg_end = (
            "Batch Merge Close Vertices concluído"
            if len(original_objs) > 1
            else "Merge Close Vertices concluído"
        )
