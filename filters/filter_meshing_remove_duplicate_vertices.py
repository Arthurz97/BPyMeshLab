...
class MESHLAB_PG_meshing_remove_duplicate_vertices(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        msg_end = (
            "Batch Remove Duplicate Vertices concluído"
            if len(original_objs) > 1
            else "Remove Duplicate Vertices concluído"
        )
