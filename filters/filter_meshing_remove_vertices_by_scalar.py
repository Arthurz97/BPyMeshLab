...
class MESHLAB_PG_meshing_remove_vertices_by_scalar(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        msg_end = (
            "Batch Remove Vertices by Quality concluído"
            if len(original_objs) > 1
            else "Remove Vertices by Quality concluído"
        )
