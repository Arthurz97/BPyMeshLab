...
class MESHLAB_PG_meshing_repair_non_manifold_vertices(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        # Processamento iterativo (Batch) forçado para evitar travamentos com geometrias non-manifold no Boolean Solver
        ...
        msg_end = (
            "Batch Repair non Manifold Vertices concluído"
            if len(original_objs) > 1
            else "Repair non Manifold Vertices concluído"
        )
