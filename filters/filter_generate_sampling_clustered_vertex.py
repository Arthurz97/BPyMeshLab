...
class MESHLAB_PG_generate_sampling_clustered_vertex(PropertyGroup, MeshLabFilterBase):
    ...
    def pre_process_parameters(cls, params, props):
        ...
        # O EnumProperty já passa a chave como String correta nativamente.
    ...
    def apply_filter(cls, context, props):
        ...
        if is_batch or len(original_objs) == 1:
            ...
            msg_end = (
                "Batch Clustered Vertex Sampling concluído"
                if len(original_objs) > 1
                else "Clustered Vertex Sampling concluído"
            )
        ...
        # MODO GLOBAL (BOOLEAN MANIFOLD VIA COLLECTION)
            ...
            return status, "Global Clustered Vertex Sampling gerado com sucesso."
