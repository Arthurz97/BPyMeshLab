...
class MESHLAB_PG_meshing_re_orient_faces_coherently(PropertyGroup, MeshLabFilterBase):
    ...
    def apply_filter(cls, context, props):
        ...
        msg_end = (
            "Batch Re-Orient Coherently concluído"
            if len(original_objs) > 1
            else "Re-Orient Coherently concluído"
        )
